...
export const PROFILE_LEVEL_COLORS: { [key: string]: string } = {
  ...
  [KANJI_KENTEI_LEVEL_ID.LEVEL_PRE2]: 'bg-indigo-500',
  [KANJI_KENTEI_LEVEL_ID.LEVEL_3]: 'bg-[#d865d8]',
  [KANJI_KENTEI_LEVEL_ID.LEVEL_4]: 'bg-[#d87070]',
  [KANJI_KENTEI_LEVEL_ID.LEVEL_5]: 'bg-yellow-600',
  [KANJI_KENTEI_LEVEL_ID.LEVEL_6]: 'bg-[#a0a010]',
  [KANJI_KENTEI_LEVEL_ID.LEVEL_7]: 'bg-emerald-600',
  [KANJI_KENTEI_LEVEL_ID.LEVEL_8]: 'bg-teal-600',
  [KANJI_KENTEI_LEVEL_ID.LEVEL_9]: 'bg-sky-600',
  [KANJI_KENTEI_LEVEL_ID.LEVEL_10]: 'bg-cyan-600',
};